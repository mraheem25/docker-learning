...
- Experienced immutability: once built, an image doesn’t change — making it reproduceable.

### Networking & Service Discovery
- Linked containers via custom networks.
- Saw microservices in action i.e. Flask app talking seamlessly to Redis or MySQL.
...
- Gained flexibility as containers now adapt to different environments without touching code.
...
### Optimising with Multi-Stage Builds
- Practiced slimming down images for production.
- Learned that smaller images allow for faster deployments.
